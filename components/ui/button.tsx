...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-1.5 whitespace-nowrap transition-all disabled:pointer-events-none disabled:opacity-40 shrink-0 outline-none",
  {
    variants: {
      variant: {
        ...
        assistive:
          "bg-background-strong hover:bg-background-heavy text-label-normal",
